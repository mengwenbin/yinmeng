...
public class SongMenuAddSongTask extends BaseRequestTask {

	public SongMenuAddSongTask(Context context,String music_id,String songmenu_id,
		...
		url = APIUrl.BASE_URL + APIUrl.SONG_MENU_ADD;
	}
