...
public class MoreRecommendPopularFragment extends BaseNewFragment implements
	...
	private final String mPageName = "MoreRecommendPopularFragment";
	...
	public int setLayoutId() {
		...
		return R.layout.fragment_more_recommend_popular;
	}
	...
	public void setupView(View view) {
		...
		listview = (XListView) view.findViewById(R.id.listview_more_recommend_popular);
	...
	public void task(){
		if (haveNetwork(context)) {
			MoreRecommendTask task = new MoreRecommendTask(context, music_category, pageNum, 2, callback);
			task.excute();
		} else {
			if (adapter != null) {
