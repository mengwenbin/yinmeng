package com.xiaoxu.music.community.view.xlistview;
...
public class XListView extends ListView implements OnScrollListener
{
	...
	public boolean mIsMorePages = false;
...
//			this.setAdapter(swingBottomInAnimationAdapter);
	...
	public void setPullRefreshEnable(boolean enable)
	{
		...
		if (!mEnablePullRefresh){
			...
			mHeaderViewContent.setVisibility(View.INVISIBLE);//不可见
		}else{
			mHeaderViewContent.setVisibility(View.VISIBLE);//可见
		}
	}
	...
	public void setPullLoadEnable(int enableState)
	{
		...
		case FOOTER_HIDE:
			...
			mFooterViewContent.setPadding(0, -mFooterViewContent.getHeight(), 0, 0);  
