...
public class MusicCategoryTask extends BaseRequestTask {

	public MusicCategoryTask(Context context, RequestCallBack<String> callback) {
		...
		url = APIUrl.BASE_URL + APIUrl.MUSIC_CATEGORY;
	}
