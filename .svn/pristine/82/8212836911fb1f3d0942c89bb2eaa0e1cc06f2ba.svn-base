 ...
 * 人气音乐列表
 */
public class PopularityMusicListTask extends BaseRequestTask{

	public PopularityMusicListTask(Context context,int pageNum,RequestCallBack<String> callback) {
		...
		url = APIUrl.BASE_URL+APIUrl.MUSIC_USER_MOODS;
	}
