...
public class RecommendMusicUserTask extends BaseRequestTask {

	public RecommendMusicUserTask(Context context,int pageNum,
		...
		url = APIUrl.BASE_URL+APIUrl.RECOMMEND_MUSIC_USER;
	}
