...
public class MineFansTask extends BaseRequestTask{
	
	/*
	 * 我的粉丝列表
	 */
	public MineFansTask(Context context,int pageNum,RequestCallBack<String> callback) {
		...
		url = APIUrl.BASE_URL + APIUrl.MINE_FANS;
	}
