	...
	public void onClick(View v) {
		...
		case R.id.btn_attention:
			...
			if(AccountInfoUtils.getInstance(context).isLogin()){
				if(haveNetwork()&&userInfo!=null){
					btn_attention.setClickable(false);
					if("0".equals(userInfo.getIs_attention()!=null?userInfo.getIs_attention():"0")){
					...
					}else if("1".equals(userInfo.getIs_attention()!=null?userInfo.getIs_attention():"0")){
