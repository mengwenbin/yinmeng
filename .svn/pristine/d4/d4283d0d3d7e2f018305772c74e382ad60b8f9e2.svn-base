...
public class SortAllFragment extends BaseNewFragment implements
	...
	private final  String mPageName = "SortAllFragment";
	...
	public int setLayoutId() {
		...
		return R.layout.fragment_sort_all;
	}
	...
	public void setupView(View view) {
		...
		listview = (XListView) view.findViewById(R.id.listview_sort_all);
	...
	public void task(){
		if (haveNetwork(context)) {
			SortListTask task = new SortListTask(context, music_category, callback);
			task.excute();
		} else {
			if (adapter != null) {
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		getParentFragment().getParentFragment().startActivityForResult(in, 14);
	}
