...
public class MoreRecommendPublicityFragment extends BaseNewFragment implements
	...
	private final String mPageName = "MoreRecommendPublicityFragment";
	...
	public int setLayoutId() {
		...
		return R.layout.fragment_more_recommend_publicity;
	}
	...
	public void setupView(View view) {
		...
		listview = (XListView) view.findViewById(R.id.listview_more_recommend_publicity);
	...
	public void task(){
		if (haveNetwork(context)) {
			MoreRecommendTask task = new MoreRecommendTask(context, music_category, pageNum, 3, callback);
			task.excute();
		} else {
			if (adapter != null) {
