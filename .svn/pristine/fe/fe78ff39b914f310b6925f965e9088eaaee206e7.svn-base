 ...
 * @author sgt
 */
public class RandomMusicListTask extends BaseRequestTask {

	public RandomMusicListTask(Context context, int pageNum,
		...
		url = APIUrl.BASE_URL+APIUrl.MUSIC_USER_RANDOM;
	}
