...
import com.xiaoxu.music.community.adapter.MineFansAdapter;
import com.xiaoxu.music.community.constant.Constant;
import com.xiaoxu.music.community.entity.FansListEntity;
import com.xiaoxu.music.community.entity.MusicUserInfoEntity;
import com.xiaoxu.music.community.model.impl.BaseRequestCallBack;
import com.xiaoxu.music.community.model.task.MineFansTask;
 ...
 * 我的粉丝模块
 */
public class MineFansActivity extends BaseNewActivity implements 
OnXListViewListener, OnClickListener,OnItemClickListener{
	...
	private MineFansTask task;
	private MineFansAdapter adapter;
	private List<MusicUserInfoEntity> list, oldlist;
	
	private final String mPageName = "MineFansActivity";
	private String Login_Tag = "com.xiaoxu.music.community.activity.MineFansActivity";
	...
	public void setupView() {
		...
		adapter = new MineFansAdapter(context,list);
	...
	public void task() {
		if (haveNetwork()) {
			...
			task = new MineFansTask(context, pageNum,callback);
			task.excute();
		} else {
			if(adapter != null){
	...
	BaseRequestCallBack callback = new BaseRequestCallBack(FansListEntity.class) {
		...
		public void onResult(String result, int code, String alert, Object obj) {
			...
			FansListEntity commentEntity = (FansListEntity) obj;
			List<MusicUserInfoEntity> lists = commentEntity.getList_fans();
