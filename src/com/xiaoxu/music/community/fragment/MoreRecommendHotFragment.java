...
public class MoreRecommendHotFragment extends BaseNewFragment implements
	...
	private final String mPageName = "MoreRecommendHotFragment";
	...
	public int setLayoutId() {
		...
		return R.layout.fragment_more_recommend_hot;
	}
	...
	public void setupView(View view) {
		...
		listview = (XListView) view.findViewById(R.id.listview_more_recommend_hot);
	...
	public void task(){
		if (haveNetwork(context)) {
			MoreRecommendTask task = new MoreRecommendTask(context, music_category, pageNum, 1, callback);
			task.excute();
		} else {
			if (adapter != null) {
