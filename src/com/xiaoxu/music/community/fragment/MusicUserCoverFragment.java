...
public class MusicUserCoverFragment extends BaseNewFragment implements  
	...
	private String music_category = "52";
	private int pageNum = 1;
	private String list_size;
	
	private MusicUserWorksFragment parentFragment;
	private final String mPageName = "MusicUserCoverFragment";
	
	public MusicUserCoverFragment(String user_id,MusicUserWorksFragment fragment) {
		super();
		this.user_id = user_id;
		this.parentFragment = fragment;
	}
	
	public MusicUserCoverFragment() {
		super();
	}
	...
	public void task(){
		if(haveNetwork(context)){
			MusicUserSongsTask task = new MusicUserSongsTask(context, user_id, music_category, pageNum, callback);
			task.excute();
		}else{
			if(adapter != null){
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		getParentFragment().startActivityForResult(in, 1);
	}
