...
import com.xiaoxu.music.community.entity.FansUserEntity;
import com.xiaoxu.music.community.entity.MusicUserInfoEntity;
import com.xiaoxu.music.community.model.impl.BaseRequestCallBack;
import com.xiaoxu.music.community.model.task.FansUserListTask;
...
public class MusicUserFansFragment extends BaseNewFragment implements OnClickListener,OnXListViewListener{
	
	private MusicUserDetailActivity act;
	
	private XListView listview;
	private FansUserListTask task;
	...
	private final  String mPageName = "MusicUserFansFragment";
	...
	public int setLayoutId() {
		...
		return R.layout.fragment_music_user_fans;
	}
	...
	public void task(){
		...
		if(haveNetwork(context)){
			task = new FansUserListTask(context, user_id, pageNum, callback);
			task.excute();
		}else{
			if(adapter != null){
	...
	BaseRequestCallBack callback = new BaseRequestCallBack(FansUserEntity.class) {
		...
		public void onResult(String result, int code, String alert, Object obj) {
			...
			if(obj==null)
				return;
			FansUserEntity entity = (FansUserEntity) obj;
			List<MusicUserInfoEntity> lists = entity.getList_fans();
