...
public class MusicUserFragment extends BaseLazyLoadFragment {
	...
	OnPageChangeListener listener = new OnPageChangeListener() {
		...
		public void onPageSelected(int position) {
			...
			case 0:
				...
				tv_approve.setTextColor(getResources().getColor(
						R.color.title_text_normal));
				tv_popularity.setTextColor(getResources().getColor(
						R.color.title_text_normal));
			...
			case 1:
				...
				tv_random.setTextColor(getResources().getColor(
						R.color.title_text_normal));
				tv_approve.setTextColor(getResources().getColor(
						R.color.title_text_normal));
				tv_popularity.setTextColor(getResources().getColor(
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (data != null) {
			...
			MusicUserInfoEntity info = (MusicUserInfoEntity) data
					.getSerializableExtra("MusicUserInfoEntity");
			if (null == info)
				return;
			switch (requestCode) {
			case 0:
				if (randomFragment != null && randomFragment.isVisible()) {
					...
					if (list != null && list.size() > position && info.getUser_id().equals(list.get(position))) {
			...
			case 1:
				...
				break;
			case 2:
				if (null != approveFragment && approveFragment.isVisible()) {
