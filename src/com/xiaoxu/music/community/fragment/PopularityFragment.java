...
import com.xiaoxu.music.community.model.task.PopularityMusicListTask;
...
public class PopularityFragment extends BaseLazyLoadFragment implements
	...
	private PopularityMusicListTask task;
	private List<MusicUserInfoEntity> list, oldlist;
	private MusicUserAdapter adapter;
	public RotateLoading rotateLoading;
	
	private final String mPageName = "PopularityFragment";
	...
	public void task() {
		if (haveNetwork(context)) {
			task = new PopularityMusicListTask(context, pageNum, callback);
			task.excute();
		} else {
			if (adapter != null) {
