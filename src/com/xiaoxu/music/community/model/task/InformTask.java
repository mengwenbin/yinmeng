...
public class InformTask extends BaseRequestTask {

	public InformTask(Context context, RequestCallBack<String> callback) {
		...
		url = APIUrl.BASE_URL + APIUrl.SYSTEM_INFROM;
	}
