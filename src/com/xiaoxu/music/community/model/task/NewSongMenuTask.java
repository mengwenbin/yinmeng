 ...
 * @author ice
 */
public class NewSongMenuTask extends BaseRequestTask {

	public NewSongMenuTask(Context context, String name,
		...
		params.addBodyParameter("MusicList[musiclist_name]", name);
		url = APIUrl.BASE_URL + APIUrl.SONG_MENU_NEW;
	}
