 ...
 * @author ice
 */
public class UserInfoTask extends BaseRequestTask {
	
	public UserInfoTask(Context context,RequestCallBack<String> callback) {
		...
		url = APIUrl.BASE_URL + APIUrl.USER_INFO;
	}
