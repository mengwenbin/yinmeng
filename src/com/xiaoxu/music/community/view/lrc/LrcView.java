package com.xiaoxu.music.community.view.lrc;
...
public class LrcView extends View implements ILrcView{
	...
	/**无歌词数据的时候 显示的默认文字**/
	private static final String DEFAULT_TEXT = "音萌音乐，传播好音乐";
	/**默认文字的字体大小**/
	private static final float SIZE_FOR_DEFAULT_TEXT = 15;
	private float size_for_default_text= ActivityUtil.sp2px(getContext(), SIZE_FOR_DEFAULT_TEXT);

	/**画高亮歌词的画笔***/
	private Paint mPaintForHighLightLrc;
	/**高亮歌词的默认字体大小***/
	private static final float DEFAULT_SIZE_FOR_HIGHT_LIGHT_LRC = 16;
	/**高亮歌词当前的字体大小***/
	private float mCurSizeForHightLightLrc = ActivityUtil.sp2px(getContext(), DEFAULT_SIZE_FOR_HIGHT_LIGHT_LRC);
	...
	/**其他歌词当前的字体大小***/
	private float mCurSizeForOtherLrc = ActivityUtil.sp2px(getContext(), DEFAULT_SIZE_FOR_OTHER_LRC);
	/**高亮歌词的默认字体颜色**/
	...
	/**时间文字大小**/
	private static final int SIZE_FOR_TIME = 13;
	/**是否画时间线**/
	...
	/**歌词当前的行距**/
	private float mCurPadding = ActivityUtil.sp2px(getContext(), DEFAULT_PADDING);
	...
	/***移动一句歌词的持续时间**/
	private static final int DURATION_FOR_LRC_SCROLL = 1300;
	/***停止触摸时 如果View需要滚动 时的持续时间**/
	private static final int DURATION_FOR_ACTION_UP = 350;//400
	...
	public void init() {
		...
		mPaintForHighLightLrc.setColor(getResources().getColor(R.color.main_color));
		...
		mPaintForTimeLine.setColor(getResources().getColor(R.color.main_color));
		mPaintForTimeLine.setTextSize(ActivityUtil.sp2px(getContext(), SIZE_FOR_TIME));
	...
	public void setmCurPadding(float mCurPadding) {
		this.mCurPadding = mCurPadding;
	}
}
